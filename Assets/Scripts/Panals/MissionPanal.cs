...
public class MissionPanal : MonoBehaviour
{
    ...
    void UpdatePanal()
    {
        ...
        {
            case 0:
                missionComplateBar.value = GameManager.Inst.CurrentUser.clickCnt / 2000f;
                missionSliderText.text = string.Format("{0} / {1}", GameManager.Inst.CurrentUser.clickCnt, 2000);
                break;
            case 1:
                missionComplateBar.value = GameManager.Inst.CurrentUser.bigHeartClickCnt / 30f;
                missionSliderText.text = string.Format("{0} / {1}", GameManager.Inst.CurrentUser.bigHeartClickCnt, 30);
                break;
            case 2:
                missionComplateBar.value = GameManager.Inst.CurrentUser.skillUseCnt / 5f;
            ...
            case 3:
                ...
                break;
            case 4:
                missionComplateBar.value = GameManager.Inst.CurrentUser.levelUpCnt / 5f;
                missionSliderText.text = string.Format("{0} / {1}", GameManager.Inst.CurrentUser.levelUpCnt, 5);
                break;
            case 5:
                missionComplateBar.value = GameManager.Inst.CurrentUser.missionClear / 5f;
